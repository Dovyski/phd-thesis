...
This chapter will mention the software I developed for all the analysis conducted during the PhD. As Henrik mentioned, I did not download a software and applied it. I created my own from scratch. The idea is not to extensively describe the software and its architecture, but to mention it here to highlight the amount of work put into this part as well. I will also mention how this software could be used in games research, for instance. 
...
The software is developed in C++ and its overall structure is illustrated in Figure \ref{fig:tool-overall-structure}.
