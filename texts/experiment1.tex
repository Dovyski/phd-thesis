...
\begin{table}
%\tbl{Performance of the rPPG technique applied to the testing set}
...
\begin{table}
%\tbl{Accuracy measurements of the rPPG technique when applied to the video segments of a given game and of all games}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/variation-roi-center.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/variation-roi-diagonal.pdf}
...
%\subfigure[]{
%\resizebox*{7cm}{!}{\includegraphics{figures/face-occlusion}}}\hspace{6pt}
%\subfigure[]{
%\resizebox*{7cm}{!}{\includegraphics{figures/head-tilt}}}
