...
\begin{figure}[h]
  ...
  \caption{Screenshots from Infinite Mario. From left to right, level types \textit{Overground}, \textit{Underground} and \textit{Castle} are displayed, respectively.}
...
\begin{figure}[ht]
    ...
    \label{fig:experiment2-training}
\end{figure}
