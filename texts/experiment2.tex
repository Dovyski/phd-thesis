...
\begin{table*}
    \centering
    \caption{Levels of Infinite Mario and the adjustments performed to induce a particular emotional state.}
    \label{table:experiment2-mario-levels}
    \begin{tabular}[l]{@{}cllp{9.0cm}}
        \hline
            \textbf{Level} & \textbf{Type} & \textbf{Emotion} & \textbf{Adjustments} \\
        \hline
            $A_1$ & Overground  & Neutral & Reduced number of interactable/collectable items and terrain obstacles; no power-ups; only 2 enemies and 1 gap (with width of Mario himself); Mario starts in big state. \\
            $A_2$ & Underground & Neutral & Regular number of interactable/collectable items, terrain obstacles, power-ups and enemies. Mario starts in small state. \\
            ...
            $B_2$ & Underground & Neutral & Regular number of interactable/collectable items, terrain obstacles, power-ups and enemies. Mario starts in small state. \\
...
As previously mentioned, the levels were adjusted and play-tested by game design experts. It ensured that the adjustments applied to each level did not affect the perception of subjects to be playing a clone of a Mario game. Additionally the order in which the levels were played, repeating the pattern of an overground, then an underground and finally a castle level should give subjects a feeling of game stody. In Super Mario, the final level of a particular world is usually a castle level with a boss. Particular attention was invested to make Infinie Mario as different as possible from the linear difficulty progression of the calibration games. The aim was to make Infinite Mario as similar to Super Mario as possible considering the mentioned content constraints.
