...
The overall hypothesis of this experiment is that the accuracy of the model during the testing phase is acceptable, validating and proving the proposed approach feasible. The next sections present the experiment, detailing the participants, structure and results, followed by a discussion and a conclusion.
...
Those numbers indicate that the sample population has a diversity of ages, gaming experience and playing frequency. The diversity of the subjects provide heterogeneous information that allows a more broad analysis of the proposed method.
