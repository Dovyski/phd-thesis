...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{Content/figures/face-muscles.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{Content/figures/samara2016sensing-distances.png}
